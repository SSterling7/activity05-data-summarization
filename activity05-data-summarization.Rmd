...
**Response**: I think the distribution would be fairly normal as the median and average are similar. The max might be an outlier and may cause a slight right skew.
...
**Response**: Engineering has the most range in their earnings, with a min of 40,000 and a max of 110,000.
